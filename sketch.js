...
//All Variables
var foodImg,foodStock,backImg, dogImg, happyDogImg, database, nowImg, lastFed = 0,frame = 1,ij = [];
...
function setup() {
    ...
    ij = ["Bed Room.png", "dogVaccination.png", "Food Stock.png", "Garden.png", "Happy.png", "Injection.png", "Lazy.png", "Living Room.png", "runnng.png"
        , "runningLeft.png", "Wash Room.png", "Vaccination.jpg"];

    backImg = loadImage(ij[round(random(0,ij.length))]);
    nowImg = dogImg;
